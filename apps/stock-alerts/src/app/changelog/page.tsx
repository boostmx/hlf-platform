...
export const metadata = {
  title: "Changelog",
  description: "Release notes and updates for HLF Stock Alerts",
};
    ...
    <div className="mx-auto max-w-2xl px-4 py-10">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground">
          Release history and updates for HLF Stock Alerts.
        </p>
      </div>
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border px-6 py-4 flex items-center justify-between">
        <Link href="/sign-in" className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-sm">HLF Stock Alerts</span>
        </Link>
        <Link
          href="/sign-in"

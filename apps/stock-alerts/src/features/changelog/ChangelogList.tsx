            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isLatest ? "border-violet-500 bg-violet-500" : "border-border bg-background",
                )}
              />
              <div className="flex flex-wrap items-center gap-2 mb-2.5">
                ...
                {isLatest && (
                  <Badge
                    variant="secondary"
                    className="bg-violet-500/10 text-violet-600 dark:text-violet-400 border border-violet-500/20 font-normal text-[11px] px-1.5 py-0"
                  >
                    Latest
                  </Badge>
                )}

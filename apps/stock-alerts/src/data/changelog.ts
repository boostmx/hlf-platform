...
export const changelog: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Behind the scenes: User identity moved to the shared @hlf/auth-db; per-user preferences (notification settings, thresholds, watched portfolios) live in this app's own DB. Cron-based scanning is paused while we batch-refactor the daily fetch.",
    ],
  },
  {
    date: "2026-05-07",
